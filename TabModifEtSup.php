    ...
    <body>
        ...
        <div class="global">
            ...
            <p class="liste" style="font-weight:bold; font-size:23px">Liste des ouvrages</p>
                ...
                <table class="table table-striped">
                    ...
                    <tbody>
                        <?php
                            ...
                            $select=$db->prepare("SELECT * FROM ouvrage WHERE id_utilisateur=$utilisateur");
                ...
                <?php
                    $select=$db->prepare("SELECT COUNT(*) AS nb FROM ouvrage  WHERE id_utilisateur=$utilisateur");
                    $select->execute(array());
                    $s= $select->fetch();
